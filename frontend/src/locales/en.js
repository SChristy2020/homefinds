export default {
  ...
  orders: {
    ...
    buyerZelleRefund: 'Zelle Refund',
    editTitle: 'Edit',
    prebookingReminderCol: '(Pre-order) Pickup Reminder',
    resendConfirmationCol: 'Resend Confirmation',
    prebookingReminderTitle: 'Send Pre-order Pickup Reminder',
    pickupReminderTitle: 'Send Pickup Reminder',
    resendConfirmationTitle: 'Resend Order Confirmation',
    resendConfirmationToast: 'Order confirmation resent',
    resendFailed: 'Resend failed: {error}',
    pickupReminderSentToast: 'Pickup reminder sent',
    prebookingReminderSentToast: 'Pre-order pickup reminder sent',
    sendFailed: 'Failed to send: {error}',
    unknownError: 'Unknown error',
    zelleByPhone: 'Phone',
    calendarTitle: 'Pickup & Rental Calendar',
    calendarSettingsTitle: 'Configure Pickup Slots',
  },
  rent: {
  ...
  rentConfirm: {
    ...
    guestsPets: 'Will there be additional occupants or pets?',
    yes: 'Yes',
    no: 'No',
    ...
    errorGuestsDesc: 'Please provide details on occupants, relationships, and pets.',
    ...
    depositPayNote: 'Deposit: A 30% down payment is required to secure your booking.',
    zelleInfo: 'Zelle Transfer Info:',
    zellePhone: 'Account: (984) 373-9392',
    zelleName: 'Recipient Name: SHU CHING LI',
    zelleMemo: 'Memo: Please include your <strong>Order No.</strong> in the memo.',
    orderNoLabel: 'Order No.',
    depositAmountLabel: 'Deposit',
    depositAmountNote: '*Please ensure the exact amount is transferred to secure your booking.',
    autoCancelNote: '*This reservation will be automatically canceled if the payment is not received within 1 hour.',
    notifyBtn: 'Deposit Paid — Notify Christy!',
    salutationLabel: 'Salutation',
    receiptTitle: 'Reservation Received!',
    receiptGreeting: '<strong>Hi {name}, thank you for your reservation!</strong>',
    receiptNote1: 'We will verify your payment and confirm your request shortly.',
    receiptNote2: '<strong>A confirmation email will be sent once the payment is processed</strong>, at which point the dates will be marked as "Reserved".',
  },
  rentSuccess: {
  ...
  reservations: {
    ...
    detailSalutation:   'Salutation',
    detailPhone:        'Phone',
    detailBirthYear:    'Birth Year',
    detailOccupation:   'Occupation',
    detailGuestsPets:   'Additional occupants or pets?',
    detailGuestsPetsYes: 'Yes',
  ...
  pickupSettings: {
    title: 'Pickup Slot Settings',
    pickupDateSection: 'Pickup Date',
    defaultDate: 'Default Date',
    endDate: 'Latest Selectable Date',
    defaultTimeSection: 'Default Time',
    defaultHour: 'Default Hour',
    defaultMinute: 'Default Minute',
    timeRangeSection: 'Pickup Time Range',
    earliest: 'Earliest',
    latest: 'Latest',
    minutesSection: 'Available Minutes',
    blockedSection: 'Blocked Time Ranges',
    noBlocked: 'None configured',
    addBlocked: '+ Add',
    cancel: 'Cancel',
    save: 'Save',
    interval10min: 'Every 10 min',
    interval15min: 'Every 15 min',
    interval20min: 'Every 20 min',
    interval30min: 'Every 30 min',
  },
}
