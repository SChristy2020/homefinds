export default {
  ...
  orders: {
    ...
    reorderBtn: '重新加入购物车',
    reorderToast: '已将商品重新加入购物车',
    editTitle: '编辑',
    prebookingReminderCol: '(预订)取货通知',
    resendConfirmationCol: '补发订单确认',
    prebookingReminderTitle: '预订取货通知',
    pickupReminderTitle: '取货通知',
    resendConfirmationTitle: '补发订单确认',
    resendConfirmationToast: '订单确认信已补发',
    resendFailed: '补发失败: {error}',
    pickupReminderSentToast: '取货通知信已寄出',
    prebookingReminderSentToast: '预订取货通知信已寄出',
    sendFailed: '寄送失败: {error}',
    unknownError: '未知错误',
    zelleByPhone: '电话',
    calendarTitle: '取货与租屋行事历',
    calendarSettingsTitle: '设定可取货时段',
  },
  rent: {
  ...
  reservations: {
    ...
    buyerZelleRefund: '退款方式',
    editNoteTitle: '编辑备注',
    zelleByPhone: '电话',
  },
  pickupSettings: {
    title: '可取货时段设定',
    pickupDateSection: '取货日期',
    defaultDate: '预设日期',
    endDate: '最晚可选日期',
    defaultTimeSection: '预设时间',
    defaultHour: '预设小时',
    defaultMinute: '预设分钟',
    timeRangeSection: '可取货时间范围',
    earliest: '最早',
    latest: '最晚',
    minutesSection: '可选分钟',
    blockedSection: '特定日期封锁时段',
    noBlocked: '尚未设定',
    addBlocked: '+ 新增',
    cancel: '取消',
    save: '储存',
