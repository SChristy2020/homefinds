export default {
  ...
  productDetail: {
    ...
    mechanism: [
      ...
      '<strong>成交確認</strong>：Christy 確認收到款項後會寄信通知您，商品也會直接改為售出狀態！',
    ],
  ...
  orders: {
    ...
    editTitle: '編輯',
    prebookingReminderCol: '(預訂)取貨通知',
    resendConfirmationCol: '補發訂單確認',
    prebookingReminderTitle: '預訂取貨通知',
    pickupReminderTitle: '取貨通知',
    resendConfirmationTitle: '補發訂單確認',
    resendConfirmationToast: '訂單確認信已補發',
    resendFailed: '補發失敗: {error}',
    pickupReminderSentToast: '取貨通知信已寄出',
    prebookingReminderSentToast: '預訂取貨通知信已寄出',
    sendFailed: '寄送失敗: {error}',
    unknownError: '未知錯誤',
    zelleByPhone: '電話',
    calendarTitle: '取貨與租屋行事曆',
    calendarSettingsTitle: '設定可取貨時段',
  },
  rent: {
  ...
  rentConfirm: {
    ...
    depositNote: '請支付 <strong>30%</strong> 租金以完成預訂！並在 note 填上你的名字。',
    cancelNote: '若 1 日內未付款，預訂將取消。',
    refundPolicy: '取消預訂的訂金退款政策',
    refund14: '退款 80%',
    refund7: '退款 50%',
    refundLess: '不退款',
  ...
  pickupSettings: {
    title: '可取貨時段設定',
    pickupDateSection: '取貨日期',
    defaultDate: '預設日期',
    endDate: '最晚可選日期',
    defaultTimeSection: '預設時間',
    defaultHour: '預設小時',
    defaultMinute: '預設分鐘',
    timeRangeSection: '可取貨時間範圍',
    earliest: '最早',
    latest: '最晚',
    minutesSection: '可選分鐘',
    blockedSection: '特定日期封鎖時段',
    noBlocked: '尚未設定',
    addBlocked: '+ 新增',
    cancel: '取消',
    save: '儲存',
