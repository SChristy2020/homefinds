          ...
          >
            ...
            <div
              ...
              :class="[
                ...
                event.pickedUp ? 'cal-event--picked-up' : (event.pendingPayment ? 'cal-event--pending-payment' : '')
              ]"
...
const calCells = computed(() => {
  ...
  const paidOrders = ordersStore.orders.filter(o => ['pending_payment', 'paid', 'picked_up'].includes(o.order_status) && o.pickup_time)
  ...
  for (let d = 1; d <= daysInMonth; d++) {
    ...
    const orderEvents = paidOrders
      ...
      .map(o => {
        ...
        return { id: `order-${o.id}`, label: fullLabel, fullLabel, type: 'order', pickedUp: o.order_status === 'picked_up', pendingPayment: o.order_status === 'pending_payment', data: o }
      })
...
.cal-event--pending-payment { background: var(--accent-light); color: var(--charcoal); }
